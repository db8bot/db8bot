exports.run = function (client, message) {
  ...
  const scopeUpdateMsg = new Discord.MessageEmbed()
    .setColor('#ff0000')
    .setTitle('db8bot Needs to be Reauthorized!')
    .setDescription('For more information, contact AirFusion#1706 on Discord')
    .addField('TL;DR', 'db8bot needs to reauthroized using [this link](https://discord.com/api/oauth2/authorize?client_id=689368779305779204&permissions=310647056497&scope=bot%20applications.commands) because Discord is enforcing slash commands in April 2022.')
