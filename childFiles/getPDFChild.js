...
process.on('message', async (msg) => {
    const pdf = await toPDF(msg.link, msg.ua, blockedPageReqRegexes[msg.reg], msg.allowCookies, msg.removeCookiesAfterLoad, msg.removeAllCookiesExcept, msg.removeCertainCookies, msg.disableJS, msg.outline)
    console.log('spawned')
    // console.log(msg.reg)
    if (msg.outline) {
